...
TEST(LuaScript, UrlParsingExample)
{
	...
	{
		LuaScript luaScript;
		luaScript.SetVariable<LuaScript::String_LuaArg>("url", "URL:host=live.system,user=test");
		std::string filter = "if url:find('user=test') then url = url:gsub('(host=)[^.]*', '%1test') end";
		luaScript.Execute(filter);
		EXPECT_EQ(std::string("URL:host=test.system,user=test"), luaScript.GetVariable<LuaScript::String_LuaArg>("url").GetValue());
	}
...
TEST(LuaScript, SetGetVariable)
{
	try
	{
		...
		EXPECT_EQ(std::string("test"), luaScript.GetVariable<LuaScript::String_LuaArg>("b").GetValue());

		luaScript.SetVariable<LuaScript::Int_LuaArg>("a", 100);
		luaScript.Execute("b = a;");
		EXPECT_EQ(100, luaScript.GetVariable<LuaScript::Int_LuaArg>("b").GetValue());

		luaScript.SetVariable<LuaScript::Bool_LuaArg>("a", true);
		luaScript.Execute("b = a;");
		EXPECT_EQ(true, luaScript.GetVariable<LuaScript::Bool_LuaArg>("b").GetValue());

		luaScript.SetVariable<LuaScript::Bool_LuaArg>("a", false);
		luaScript.Execute("b = a;");
		EXPECT_EQ(false, luaScript.GetVariable<LuaScript::Bool_LuaArg>("b").GetValue());
	}
	catch(const LuaScript::LuaException& e)
	{
		FAIL() << "error: " << e.Error() << ", line " << e.Line();
...
TEST(LuaScript, RequirePackageBase64)
{
	try
	{
		...
		EXPECT_EQ(std::string("dGVzdA=="), luaScript.GetVariable<LuaScript::String_LuaArg>("a").GetValue());
	}
	catch(const LuaScript::LuaException& e)
	{
		FAIL() << "error: " << e.Error() << ", line " << e.Line();
...
TEST(LuaScript, TestMath1)
{
	try
	{
		...
		EXPECT_EQ(false, ret)  << "/n check luai_nummod(): may be floor() change to round()";
	}
	catch(const LuaScript::LuaException& e)
	{
		FAIL() << "error: " << e.Error() << ", line " << e.Line();
...
TEST(LuaScript, TestMath2)
{
	try
	{
		...
		bool ret = luaScript.GetVariable<LuaScript::Bool_LuaArg>("b").GetValue();
		EXPECT_EQ(true, ret)  << "/n check luai_nummod(): may be floor() change to round()";
	}
	catch(const LuaScript::LuaException& e)
	{
		FAIL() << "error: " << e.Error() << ", line " << e.Line();
...
TEST(LuaScript, FileExistsFunction)
{
	try
	{
		...
		luaScript.SetVariable<LuaScript::String_LuaArg>("fname", "./luascript/luascript_unittest.cpp");
		luaScript.Execute("exists = fs.file_exists(fname);");
		EXPECT_EQ(true, luaScript.GetVariable<LuaScript::Bool_LuaArg>("exists").GetValue());

		luaScript.SetVariable<LuaScript::String_LuaArg>("fname", std::string("its_nonexisting_h"));
		luaScript.Execute("exists = fs.file_exists(fname);");
		EXPECT_EQ(false, luaScript.GetVariable<LuaScript::Bool_LuaArg>("exists").GetValue());
	}
	catch(const LuaScript::LuaException& e)
	{
		FAIL() << "error: " << e.Error() << ", line " << e.Line();
...
TEST(LuaScript, ReturnSomeFromFunction)
{
	try
	{
		...
		EXPECT_EQ(true, luaScript.GetVariable<LuaScript::Bool_LuaArg>("b").GetValue());
		EXPECT_EQ(100, luaScript.GetVariable<LuaScript::Int_LuaArg>("i").GetValue());
		EXPECT_EQ("test", luaScript.GetVariable<LuaScript::String_LuaArg>("s").GetValue());
	}
	catch(const LuaScript::LuaException& e)
	{
		FAIL() << "error: " << e.Error() << ", line " << e.Line();
...
class LuaReturnEqualParamFuntion
{
public:
	LuaReturnEqualParamFuntion(LuaScript* a_Parent) { }
	...
	void Calc(const LuaScript::LuaArgArray& in, LuaScript::LuaArgArray& out) 
	{
		dynamic_cast<LuaScript::Bool_LuaArg&>(*out[0]).SetValue	(dynamic_cast<LuaScript::Bool_LuaArg&>(*in[0]).GetValue());
		dynamic_cast<LuaScript::Int_LuaArg&>(*out[1]).SetValue	(dynamic_cast<LuaScript::Int_LuaArg&>(*in[1]).GetValue());
		dynamic_cast<LuaScript::String_LuaArg&>(*out[2]).SetValue(dynamic_cast<LuaScript::String_LuaArg&>(*in[2]).GetValue());
		dynamic_cast<LuaScript::Bool_LuaArg&>(*out[3]).SetValue	(dynamic_cast<LuaScript::Bool_LuaArg&>(*in[3]).GetValue());
		dynamic_cast<LuaScript::VectorInt_LuaArg&>(*out[4]).SetValue(dynamic_cast<LuaScript::VectorInt_LuaArg&>(*in[4]).GetValue());
		dynamic_cast<LuaScript::VectorString_LuaArg&>(*out[5]).SetValue(dynamic_cast<LuaScript::VectorString_LuaArg&>(*in[5]).GetValue());
	}
};
...
TEST(LuaScript, MultiReturnEqualFromFunction) 
{
	...
	{
		LuaScript luaScript;
		luaScript.RegisterFunction<LuaReturnEqualParamFuntion>();
		std::string strScript = 
					"local testTable = { 0, 1, 2, 3 }; \n"
					"local testStringTable = { 'test0', 'test1', 'test2', 'qwertyuiop[]asdfghjkl;zxcvbnm,./`1234567890-=' }; \n"
					"b, i, s, b1, retTable, retStringTable = test.return_list(true, 10, \"test\", false, testTable, testStringTable);";
		luaScript.Execute(strScript.c_str());
		EXPECT_EQ(true, luaScript.GetVariable<LuaScript::Bool_LuaArg>("b").GetValue());
		EXPECT_EQ(10, luaScript.GetVariable<LuaScript::Int_LuaArg>("i").GetValue());
		EXPECT_EQ("test", luaScript.GetVariable<LuaScript::String_LuaArg>("s").GetValue());
		EXPECT_EQ(false, luaScript.GetVariable<LuaScript::Bool_LuaArg>("b1").GetValue());
	
		std::vector<int> retInt = luaScript.GetVariable<LuaScript::VectorInt_LuaArg>("retTable").GetValue();
		...
		std::vector<std::string> retStr = luaScript.GetVariable<LuaScript::VectorString_LuaArg>("retStringTable").GetValue();
		...
		EXPECT_STREQ("qwertyuiop[]asdfghjkl;zxcvbnm,./`1234567890-=", retStr[3].c_str());
	}
	catch(const LuaScript::LuaException& e) 
	{
		FAIL() << "error: " << e.Error() << ", line " << e.Line();
...
class LuaTestParentFuntion
{
public:
	LuaTestParentFuntion(LuaScript* a_Parent)
	{
	...
	void Calc(const LuaScript::LuaArgArray& in, LuaScript::LuaArgArray& out) 
	{
		...
		m_Parent->m_TestParametr = dynamic_cast<LuaScript::Int_LuaArg&>(*in[0]).GetValue();
		dynamic_cast<LuaScript::Bool_LuaArg&>(*out[0]).SetValue(true);
	}
private:
...
TEST(LuaScript, CheckParent) 
{
	try 
	{
		...
		luaScript.RegisterFunction<LuaTestParentFuntion>();
...
class LuaNullNameSpaceFuntion
{
public:
	LuaNullNameSpaceFuntion(LuaScript* a_Parent) 
	{
		m_Parent = a_Parent;
	}
...
TEST(LuaScript, CheckNullNameSpaceFuntion) 
{
	try 
	{
		LuaScript luaScript;
		luaScript.RegisterFunction<LuaNullNameSpaceFuntion>();

		luaScript.Execute("ret = return_true();");
		
		EXPECT_EQ(true, luaScript.GetVariable<LuaScript::Bool_LuaArg>("ret").GetValue());
	}
	catch(const LuaScript::LuaException& e) 
	{
		FAIL() << "error: " << e.Error() << ", line " << e.Line();
